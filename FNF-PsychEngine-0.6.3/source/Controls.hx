...
class Controls extends FlxActionSet
{
	...
	var _hey = new FlxActionDigital(Action.HEY);
	...
	public function setKeyboardScheme(scheme:KeyboardScheme, reset = true)
	{
		...
		switch (scheme)
		{
			case Solo:
				...
				inline bindKeys(Control.HEY, keysMap.get('hey'));
			...
			case Duo(true):
				...
				inline bindKeys(Control.HEY, [SHIFT]);
			...
			case Duo(false):
				...
				inline bindKeys(Control.HEY, [ZERO]);
				inline bindKeys(Control.DODGE, [TWO]);
			case None: // nothing
			case Custom: // nothing
		}
		#else
		switch (scheme)
		{
			...
			case Duo(true):
				...
				bindKeys(Control.RESET, [R]);
				bindKeys(Control.HEY, [ZERO]);
				bindKeys(Control.DODGE, [TWO]);
			case Duo(false):
